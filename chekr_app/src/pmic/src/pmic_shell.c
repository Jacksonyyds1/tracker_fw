...
void power_wifi_modem_cmd(const struct shell *sh, size_t argc, char **argv)
{
	util_enable_dialog(true);
	util_enable_9160(true);
    shell_print(sh, "Powered on Dialog and 9160");
}
...
SHELL_CMD_REGISTER(power_wifi_modem, NULL, "Power on DA and 9160", power_wifi_modem_cmd);
