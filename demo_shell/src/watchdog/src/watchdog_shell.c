...
void disable_watchdog_kick_cmd(const struct shell *sh, size_t argc, char **argv)
{
    ARG_UNUSED(argc);
	ARG_UNUSED(argv);
...
void disable_watchdog_cmd(const struct shell *sh, size_t argc, char **argv)
{
    ARG_UNUSED(argc);
    ARG_UNUSED(argv);
...
void enable_watchdog_cmd(const struct shell *sh, size_t argc, char **argv)
{
    ARG_UNUSED(argc);
    ARG_UNUSED(argv);
