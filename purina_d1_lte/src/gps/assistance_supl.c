...
#define SUPL_SERVER        CONFIG_PURINA_D1_LTE_SUPL_HOSTNAME
#define SUPL_SERVER_PORT   CONFIG_PURINA_D1_LTE_SUPL_PORT

BUILD_ASSERT(sizeof(CONFIG_PURINA_D1_LTE_SUPL_HOSTNAME) > 1, "Server hostname must be configured");
